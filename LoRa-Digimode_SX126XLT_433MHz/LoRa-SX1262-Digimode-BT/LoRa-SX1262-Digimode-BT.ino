 ...
 * 
 *  The SX1262 1W module is controlled by the following library
...
String BTName ; // = "ZP4KFX-2.4GHz"; //Bluetooth device name that you like
...
void LoRaTX(String Message ) {  // TX a string
    digitalWrite(ledtx, HIGH); 
        ...
        Message.getBytes(dataArray,   1 + Message.length()); // + 1
     
    TXPacketL = sizeof(dataArray) - 1 ; 
...
digitalWrite(LED1, HIGH); 
   //Serial.print("Received packet '");
                  ...
                  SerialBT.print("[RSSI: ");
                  SerialBT.print(PacketRSSI);
                  SerialBT.print(" SNR: ");
                  SerialBT.print(PacketSNR);
                  SerialBT.print("]>");
    //LT.printASCIIPacket(RXBUFFER, RXPacketL);        //print the packet as ASCII characters
...
void setup()
{
  ...
  BTName = preferences.getString("BTName", "N0CALL-SX1262");
